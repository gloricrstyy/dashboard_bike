...
# Pertanyaan Bisnis 2: Berapa jumlah sepeda yang pininjam berdasarkan musim?
...
ax.bar(df_musim['season'], df_musim['cnt'])
ax.set_xlabel('Musim')
ax.set_ylabel('Jumlah Sepeda yang Dipinjam')
ax.set_title('Jumlah Sepeda yang Dipinjam pada Setiap Musim')
st.pyplot(fig)